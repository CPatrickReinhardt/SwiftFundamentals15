...
print("The people on the regisration list are: \(registrationList)")
...
registrationList += ["Lydia", "Lauren", "Alicia", "Rachel"]
print("The people on the registration list are: \(registrationList)")
