...
var name : String
//print (name)
print ("no this doesn not compile")
...
print("No, this does not compile beacuse swift read the 0 as int and set the type to int then we tried to make it a double. After exliciting a type to double it works properly")
