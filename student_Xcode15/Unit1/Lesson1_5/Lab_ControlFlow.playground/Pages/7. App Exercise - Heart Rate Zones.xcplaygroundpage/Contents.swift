...
switch currentHR{
case 100...120:
    print("You are in the Very Light zone. Activity in this zone helps witrh recovery.")
case 121...140:
...
default:
    if currentHR > 200{
        print("Warning! heart rate too high. Please slow down!")
    } else {
        print("heart rate is below 100. Pick It Up! ")
    }
}
/*:
