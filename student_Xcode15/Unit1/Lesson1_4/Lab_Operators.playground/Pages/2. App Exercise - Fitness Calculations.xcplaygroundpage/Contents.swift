...
print (averageHRD)
print ("yes, these are different values because before it disregarded the remainder as an integer type. As a Double type it takes into account the remainder as a decimal value.")
...
print ("You're Percent of Goal is:",percentOfGoal,"%")
/*:
