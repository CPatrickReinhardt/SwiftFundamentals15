...
print ("It is differnet than the integer value because it takes into the account the remainder as a decimal/double value ")
/*:
...
let isEven = even % 2
let isOdd = odd % 2
print("The modulus or remainder operator can be used to determin if a number is even or odd because the rainder of an even number would be 0 and the remainder of an odd number would have a value")
/*:
